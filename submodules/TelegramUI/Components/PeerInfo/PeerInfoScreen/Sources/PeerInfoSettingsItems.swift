...
private func mqgramSettingsMenuIcon() -> UIImage? {
    ...
    return PresentationResourcesSettings.mqgram
}
...
//            }))
        ...
        items[.myProfile]!.append(PeerInfoScreenDisclosureItem(id: 1001, text: "MQGram", icon: mqgramSettingsMenuIcon(), action: {
